...
public static class ChordSyntax
{
    ...
    /// <summary>The keys that are modifiers and nothing else; a non-tap chord's key is never one of them (a tap chord's
    /// key always is: KeyChord.TapOf(Key.LeftCtrl)).</summary>
