...
/// whichever order those happen. With the splash turned off (#108) App reports it closed before the plan is known,
/// so the plan runs as soon as it arrives. A splash whose maximum has already elapsed closes synchronously inside
